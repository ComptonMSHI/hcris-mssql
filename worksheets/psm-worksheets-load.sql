        ...
        ************************************************************/
        ...
        IF @ProductionMode = 1
            BEGIN
                ...
                -- UPDATE MCR_WORKSHEETS SET CLMN_NUM = '000' WHERE CLMN_NUM = '';
                UPDATE MCR_WORKSHEETS SET SUBCLMN_NUM = '00' WHERE SUBCLMN_NUM Is Null OR SUBCLMN_NUM = '';

                DELETE FROM MCR_WORKSHEETS WHERE CLMN_NUM = '' OR CLMN_NUM Is Null;
                ...
                CREATE INDEX i2d ON MCR_WORKSHEETS (FORM_NUM ASC, WKSHT_CD ASC, LINE_NUM ASC, CLMN_NUM ASC);

                DROP INDEX IF EXISTS i2e ON MCR_WORKSHEETS;
                CREATE INDEX i2e ON MCR_WORKSHEETS (WKSHT_CD ASC, FORM_NUM ASC, LINE_NUM ASC, CLMN_NUM ASC, SUBLINE_NUM ASC, SUBCLMN_NUM ASC);
